...
<head>
  ...
  <style>
    * {
      ...
      scrollbar-color: #232B42 transparent;
    }
    ...
    .glow-focus:focus {
      outline: none;
      box-shadow: 0 0 0 3px rgba(31, 216, 196, .18);
      border-color: #1FD8C4;
    }

    .grad-flow {
      background: linear-gradient(135deg, #1FD8C4 0%, #0EA394 100%);
    }

    .text-grad {
      background: linear-gradient(135deg, #1FD8C4 0%, #60A5FA 100%);
